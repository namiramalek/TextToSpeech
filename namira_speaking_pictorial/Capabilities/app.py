...
SpeechTranslation_service = speech_service.SpeechRecognition()
...
def translate_image_text(image_id):
    ...
    text_lines = recognition_service.text_detect(image_id)
    ...
    myString = ' '.join(list(translated_line.items())[0])
    print(translated_line)
            
            
    #translate text to speech
    SpeechTranslation_service.text_to_speech(myString)
